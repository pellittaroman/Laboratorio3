...
(function (Vehiculo) {
    ...
    function Modificar(event) {
        ...
        $("#btnModificar").click(function () {
            ...
            var vehiculo;
            if (tipo == "Auto") {
                vehiculo = new Vehiculo.Auto(id, String($("#txtMarca").val()), String($("#txtModelo").val()), Number($("#txtPrecio").val()), 2);
            }
            else {
                vehiculo = new Vehiculo.Camioneta(id, String($("#txtMarca").val()), String($("#txtModelo").val()), Number($("#txtPrecio").val()), true);
            }
            lista = [];
            localStorage.clear();
            for (var i = 0; i < carga.length; i++) {
